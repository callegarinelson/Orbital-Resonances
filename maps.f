     ...
     |xpla(6,6),f(6),bx(6,1),by(6,1),bz(6,1)
      REAL*8 XAFFT(1048576),XEFFT(1048576),XIFFT(1048576)

      REAL*8 NLINHAS,DELTAT,ttf,tint

            INTEGER n,nn,i,ii,j,kk,isign,iii,ioi
            
      INTEGER nespec1,nespec5,nespec10,nespec15,
     >nespec20,nespec25,nespec30,nespec35,nespec40,nespec45,nespec50,
     >dn1 , dn5,dn10,dn15,dn20,dn25,dn30,
     >dn35,dn40,dn45,dn50
...
c      i_atual=1.095303714535553d-03*conv

        ei=0.0d0
	ef=0.005d0
	de=(ef-ei)/100.0d0

	semi0=168000.0d0/60268.0d0
	semif=168060.0d0/60268.0d0
	dsemi=(semif-semi0)/150.0d0
...
c	write(*,*)tint/365.25d0
      ...
      OPEN(92311,FILE='emax-t.dat',STATUS='UNKNOWN')
      OPEN(9234,FILE='amax-t.dat',STATUS='UNKNOWN')
      OPEN(92345,FILE='imax-t.dat',STATUS='UNKNOWN')

	write(1239,'(4hDSAA)')
	write(1239,*)'101 71'
	write(1239,*)'167980 168080'
	write(1239,*)'0 +0.01'
   	write(1239,*)'1 100'

	write(12349,'(4hDSAA)')
	write(12349,*)'101 71'
	write(12349,*)'167980 168080'
	write(12349,*)'0 +0.01'
   	write(12349,*)'1 100'

	write(23459,'(4hDSAA)')
	write(23459,*)'101 71'
	write(23459,*)'167980 168080'
	write(23459,*)'0 +0.01'
   	write(23459,*)'1 100'
...
c	ARQUIVOS DE FFT DO SEMI-EIXO		
      OPEN(2,FILE='dn1a.grd',STATUS='UNKNOWN')
      OPEN(22,FILE='e1e2dn1a.dat',STATUS='UNKNOWN')

      OPEN(3,FILE='dn5a.grd',STATUS='UNKNOWN')
      OPEN(33,FILE='e1e2dn5a.dat',STATUS='UNKNOWN')

      OPEN(4,FILE='dn10a.grd',STATUS='UNKNOWN')
      OPEN(44,FILE='e1e2dn10a.dat',STATUS='UNKNOWN')

      OPEN(41,FILE='dn15a.grd',STATUS='UNKNOWN')
      OPEN(441,FILE='e1e2dn15a.dat',STATUS='UNKNOWN')

      OPEN(5,FILE='dn20a.grd',STATUS='UNKNOWN')
      OPEN(55,FILE='e1e2dn20a.dat',STATUS='UNKNOWN')

      OPEN(622,FILE='dn25a.grd',STATUS='UNKNOWN')
      OPEN(662,FILE='e1e2dn25a.dat',STATUS='UNKNOWN')

      OPEN(7,FILE='dn30a.grd',STATUS='UNKNOWN')
      OPEN(77,FILE='e1e2dn30a.dat',STATUS='UNKNOWN')
      
      OPEN(8,FILE='dn35a.grd',STATUS='UNKNOWN')
      OPEN(88,FILE='e1e2dn35a.dat',STATUS='UNKNOWN')

      OPEN(9,FILE='dn40a.grd',STATUS='UNKNOWN')
      OPEN(99,FILE='e1e2dn40a.dat',STATUS='UNKNOWN')

      OPEN(92,FILE='dn45a.grd',STATUS='UNKNOWN')
      OPEN(922,FILE='e1e2dn45a.dat',STATUS='UNKNOWN')

      OPEN(93,FILE='dn50a.grd',STATUS='UNKNOWN')
      OPEN(923,FILE='e1e2dn50a.dat',STATUS='UNKNOWN')


	write(2,'(4hDSAA)')
	write(2,*)'101 71'
	write(2,*)'167980 168080'
	write(2,*)'0 +0.01'
   	write(2,*)'1 100'

	write(3,'(4hDSAA)')
	write(3,*)'101 71'
	write(3,*)'167980 168080'
	write(3,*)'0 +0.01'
   	write(3,*)'1 100'

	write(4,'(4hDSAA)')
	write(4,*)'101 71'
	write(4,*)'167980 168080'
	write(4,*)'0 +0.01'
   	write(4,*)'1 100'

	write(41,'(4hDSAA)')
	write(41,*)'101 71'
	write(41,*)'167980 168080'
	write(41,*)'0 +0.01'
   	write(41,*)'1 100'

	write(5,'(4hDSAA)')
	write(5,*)'101 71'
	write(5,*)'167980 168080'
	write(5,*)'0 +0.01'
   	write(5,*)'1 100'

	write(622,'(4hDSAA)')
 	write(622,*)'101 71'
	write(622,*)'167980 168080'
	write(622,*)'0 +0.01'
   	write(622,*)'1 100'

	write(7,'(4hDSAA)')
	write(7,*)'101 71'
	write(7,*)'167980 168080'
	write(7,*)'0 +0.01'
   	write(7,*)'1 100'

	write(8,'(4hDSAA)')
	write(8,*)'101 71'
	write(8,*)'167980 168080'
	write(8,*)'0 +0.01'
   	write(8,*)'1 100'

	write(9,'(4hDSAA)')
	write(9,*)'101 71'
	write(9,*)'167980 168080'
	write(9,*)'0 +0.01'
   	write(9,*)'1 100'

	write(92,'(4hDSAA)')
	write(92,*)'101 71'
	write(92,*)'167980 168080'
	write(92,*)'0 +0.01'
   	write(92,*)'1 100'
   	
	write(93,'(4hDSAA)')
	write(93,*)'101 71'
	write(93,*)'167980 168080'
	write(93,*)'0 +0.01'
   	write(93,*)'1 100'
   	
C	ARQUIVOS DE FFT da excentricidade

      OPEN(29,FILE='dn1.grd',STATUS='UNKNOWN')
      OPEN(229,FILE='e1e2dn1.dat',STATUS='UNKNOWN')

      OPEN(39,FILE='dn5.grd',STATUS='UNKNOWN')
      OPEN(339,FILE='e1e2dn5.dat',STATUS='UNKNOWN')

      OPEN(49,FILE='dn10.grd',STATUS='UNKNOWN')
      OPEN(449,FILE='e1e2dn10.dat',STATUS='UNKNOWN')

      OPEN(491,FILE='dn15.grd',STATUS='UNKNOWN')
      OPEN(4491,FILE='e1e2dn15.dat',STATUS='UNKNOWN')

      OPEN(59,FILE='dn20.grd',STATUS='UNKNOWN')
      OPEN(559,FILE='e1e2dn20.dat',STATUS='UNKNOWN')

      OPEN(6229,FILE='dn25.grd',STATUS='UNKNOWN')
      OPEN(6629,FILE='e1e2dn25.dat',STATUS='UNKNOWN')

      OPEN(79,FILE='dn30.grd',STATUS='UNKNOWN')
      OPEN(779,FILE='e1e2dn30.dat',STATUS='UNKNOWN')

      OPEN(89,FILE='dn35.grd',STATUS='UNKNOWN')
      OPEN(8779,FILE='e1e2dn35.dat',STATUS='UNKNOWN')

      OPEN(919,FILE='dn40.grd',STATUS='UNKNOWN')
      OPEN(9779,FILE='e1e2dn40.dat',STATUS='UNKNOWN')

      OPEN(929,FILE='dn45.grd',STATUS='UNKNOWN')
      OPEN(92779,FILE='e1e2dn45.dat',STATUS='UNKNOWN')

      OPEN(939,FILE='dn50.grd',STATUS='UNKNOWN')
      OPEN(93779,FILE='e1e2dn50.dat',STATUS='UNKNOWN')


	write(29,'(4hDSAA)')
	write(29,*)'101 71'
	write(29,*)'167980 168080'
	write(29,*)'0 +0.01'
   	write(29,*)'1 100'

	write(39,'(4hDSAA)')
	write(39,*)'101 71'
	write(39,*)'167980 168080'
	write(39,*)'0 +0.01'
   	write(39,*)'1 100'

	write(49,'(4hDSAA)')
	write(49,*)'101 71'
	write(49,*)'167980 168080'
	write(49,*)'0 +0.01'
   	write(49,*)'1 100'

	write(491,'(4hDSAA)')
	write(491,*)'101 71'
	write(491,*)'167980 168080'
	write(491,*)'0 +0.01'
   	write(491,*)'1 100'

	write(59,'(4hDSAA)')
	write(59,*)'101 71'
	write(59,*)'167980 168080'
	write(59,*)'0 +0.01'
   	write(59,*)'1 100'

	write(6229,'(4hDSAA)')
 	write(6229,*)'101 71'
	write(6229,*)'167980 168080'
	write(6229,*)'0 +0.01'
   	write(6229,*)'1 100'

	write(79,'(4hDSAA)')
	write(79,*)'101 71'
	write(79,*)'167980 168080'
	write(79,*)'0 +0.01'
   	write(79,*)'1 100'

	write(89,'(4hDSAA)')
	write(89,*)'101 71'
	write(89,*)'167980 168080'
	write(89,*)'0 +0.01'
   	write(89,*)'1 100'
   	
	write(919,'(4hDSAA)')
	write(919,*)'101 71'
	write(919,*)'167980 168080'
	write(919,*)'0 +0.01'
   	write(919,*)'1 100'

	write(929,'(4hDSAA)')
	write(929,*)'101 71'
	write(929,*)'167980 168080'
	write(929,*)'0 +0.01'
   	write(929,*)'1 100'
   	
	write(939,'(4hDSAA)')
	write(939,*)'101 71'
	write(939,*)'167980 168080'
	write(939,*)'0 +0.01'
   	write(939,*)'1 100'
...
C	ARQUIVOS DE FFT da inclinacao
      ...
      OPEN(290,FILE='dn1i.grd',STATUS='UNKNOWN')
      OPEN(2290,FILE='e1e2dn1i.dat',STATUS='UNKNOWN')

      OPEN(390,FILE='dn5i.grd',STATUS='UNKNOWN')
      OPEN(3390,FILE='e1e2dn5i.dat',STATUS='UNKNOWN')

      OPEN(490,FILE='dn10i.grd',STATUS='UNKNOWN')
      OPEN(4490,FILE='e1e2dn10i.dat',STATUS='UNKNOWN')

      OPEN(4901,FILE='dn15i.grd',STATUS='UNKNOWN')
      OPEN(44901,FILE='e1e2dn15i.dat',STATUS='UNKNOWN')

      OPEN(590,FILE='dn20i.grd',STATUS='UNKNOWN')
      OPEN(5590,FILE='e1e2dn20i.dat',STATUS='UNKNOWN')

      OPEN(62290,FILE='dn25i.grd',STATUS='UNKNOWN')
      OPEN(66290,FILE='e1e2dn25i.dat',STATUS='UNKNOWN')

      OPEN(790,FILE='dn30i.grd',STATUS='UNKNOWN')
      OPEN(7790,FILE='e1e2dn30i.dat',STATUS='UNKNOWN')

      OPEN(7901,FILE='dn35i.grd',STATUS='UNKNOWN')
      OPEN(77901,FILE='e1e2dn35i.dat',STATUS='UNKNOWN')

      OPEN(7902,FILE='dn40i.grd',STATUS='UNKNOWN')
      OPEN(77902,FILE='e1e2dn40i.dat',STATUS='UNKNOWN')

      OPEN(7903,FILE='dn45i.grd',STATUS='UNKNOWN')
      OPEN(77903,FILE='e1e2dn45i.dat',STATUS='UNKNOWN')

      OPEN(7904,FILE='dn50i.grd',STATUS='UNKNOWN')
      OPEN(77904,FILE='e1e2dn50i.dat',STATUS='UNKNOWN')
      

	write(290,'(4hDSAA)')
	write(290,*)'101 71'
	write(290,*)'167980 168080'
	write(290,*)'0 +0.01'
   	write(290,*)'1 100'

	write(390,'(4hDSAA)')
	write(390,*)'101 71'
	write(390,*)'167980 168080'
	write(390,*)'0 +0.01'
   	write(390,*)'1 100'

	write(490,'(4hDSAA)')
	write(490,*)'101 71'
	write(490,*)'167980 168080'
	write(490,*)'0 +0.01'
   	write(490,*)'1 100'

	write(4901,'(4hDSAA)')
	write(4901,*)'101 71'
	write(4901,*)'167980 168080'
	write(4901,*)'0 +0.01'
   	write(4901,*)'1 100'

	write(590,'(4hDSAA)')
	write(590,*)'101 71'
	write(590,*)'167980 168080'
	write(590,*)'0 +0.01'
   	write(590,*)'1 100'

	write(62290,'(4hDSAA)')
 	write(62290,*)'101 71'
	write(62290,*)'167980 168080'
	write(62290,*)'0 +0.01'
   	write(62290,*)'1 100'

	write(790,'(4hDSAA)')
	write(790,*)'101 71'
	write(790,*)'167980 168080'
	write(790,*)'0 +0.01'
   	write(790,*)'1 100'

	write(7901,'(4hDSAA)')
	write(7901,*)'101 71'
	write(7901,*)'167980 168080'
	write(7901,*)'0 +0.01'
   	write(7901,*)'1 100'
   	
	write(7902,'(4hDSAA)')
	write(7902,*)'101 71'
	write(7902,*)'167980 168080'
	write(7902,*)'0 +0.01'
   	write(7902,*)'1 100'
   	
	write(7903,'(4hDSAA)')
	write(7903,*)'101 71'
	write(7903,*)'167980 168080'
	write(7903,*)'0 +0.01'
   	write(7903,*)'1 100'
   	
      	write(7904,'(4hDSAA)')
	write(7904,*)'101 71'
	write(7904,*)'167980 168080'
	write(7904,*)'0 +0.01'
   	write(7904,*)'1 100'
...
c99	Format(F11.3,1x,F12.5,1x,F9.6,1x,F12.8,1x,F10.8)
	...
	write(92311,*)ttt,ttt/365.25d0,semi,exc,emax
...
c     >XI3FFT,XA4FFT,XA5FFT,XE5FFT,XA6FFT)   
	...
	CALL FFT(XAFFT,nespec1,nespec5,nespec10,nespec15,
     >nespec20,nespec25,nespec30,nespec35,nespec40,nespec45,nespec50,
     >exc,semi,iii,ioi)
     
	write(2,*)nespec1
	write(22,*)exc,semi*60268.0d0,nespec1

	write(3,*)nespec5
	write(33,*)exc,semi*60268.0d0,nespec5

	write(4,*)nespec10
	write(44,*)exc,semi*60268.0d0,nespec10

	write(41,*)nespec15
	write(441,*)exc,semi*60268.0d0,nespec15

	write(5,*)nespec20
	write(55,*)exc,semi*60268.0d0,nespec20

	write(622,*)nespec25
	write(662,*)exc,semi*60268.0d0,nespec25

	write(7,*)nespec30
	write(77,*)exc,semi*60268.0d0,nespec30
	
	write(8,*)nespec35
	write(88,*)exc,semi*60268.0d0,nespec35

       	write(9,*)nespec40
	write(99,*)exc,semi*60268.0d0,nespec40

	write(92,*)nespec45
	write(922,*)exc,semi*60268.0d0,nespec45

	write(93,*)nespec50
	write(923,*)exc,semi*60268.0d0,nespec50

	
	ioi=0

	iii=2
	CALL FFT(XEFFT,nespec1,nespec5,nespec10,nespec15,
     >nespec20,nespec25,nespec30,nespec35,nespec40,nespec45,nespec50,
     >exc,semi,iii,ioi)

	write(29,*)nespec1
	write(229,*)exc,semi*60268.0d0,nespec1

	write(39,*)nespec5
	write(339,*)exc,semi*60268.0d0,nespec5

	write(49,*)nespec10
	write(449,*)exc,semi*60268.0d0,nespec10

	write(491,*)nespec15
	write(4491,*)exc,semi*60268.0d0,nespec15

	write(59,*)nespec20
	write(559,*)exc,semi*60268.0d0,nespec20

	write(6229,*)nespec25
	write(6629,*)exc,semi*60268.0d0,nespec25

	write(79,*)nespec30
	write(779,*)exc,semi*60268.0d0,nespec30

	write(89,*)nespec35
	write(8779,*)exc,semi*60268.0d0,nespec35

       	write(919,*)nespec40
	write(9779,*)exc,semi*60268.0d0,nespec40

       	write(929,*)nespec45
	write(92779,*)exc,semi*60268.0d0,nespec45

       	write(939,*)nespec50
	write(93779,*)exc,semi*60268.0d0,nespec50


	iii=3
	
	CALL FFT(XIFFT,nespec1,nespec5,nespec10,nespec15,
     >nespec20,nespec25,nespec30,nespec35,nespec40,nespec45,nespec50,
     >exc,semi,iii,ioi)


	write(290,*)nespec1
	write(2290,*)exc,semi*60268.0d0,nespec1

	write(390,*)nespec5
	write(3390,*)exc,semi*60268.0d0,nespec5

	write(490,*)nespec10
	write(4490,*)exc,semi*60268.0d0,nespec10

	write(4901,*)nespec15
	write(44901,*)exc,semi*60268.0d0,nespec15

	write(590,*)nespec20
	write(5590,*)exc,semi*60268.0d0,nespec20

	write(62290,*)nespec25
	write(66290,*)exc,semi*60268.0d0,nespec25

	write(790,*)nespec30
	write(7790,*)exc,semi*60268.0d0,nespec30
	
	write(7901,*)nespec35
	write(77901,*)exc,semi*60268.0d0,nespec35

	write(7902,*)nespec40
	write(77902,*)exc,semi*60268.0d0,nespec40
	
	write(7903,*)nespec45
	write(77903,*)exc,semi*60268.0d0,nespec45
	
	write(7904,*)nespec50
	write(77904,*)exc,semi*60268.0d0,nespec50
...
cccccccccccccccccccccccccccccccccccccccccccccccccc
      SUBROUTINE FFT(XE2FFT,nespec1,nespec5,nespec10,nespec15,
     >nespec20,nespec25,nespec30,nespec35,nespec40,nespec45,nespec50,
     >exc,semi,iii,ioi)
...
c      open (473,file='EcosVmedio.grd', status='unknown')
	...
	write(171,'(4hDSAA)')
	write(171,*)'101 71'
	write(171,*)'167980 168080'
	write(171,*)'0 +0.01'
   	write(171,*)'1 100'

	write(272,'(4hDSAA)')
	write(272,*)'101 71'
	write(272,*)'167980 168080'
	write(272,*)'0 +0.01'
   	write(272,*)'1 100'

	write(373,'(4hDSAA)')
	write(373,*)'101 71'
	write(373,*)'167980 168080'
	write(373,*)'0 +0.01'
   	write(373,*)'1 100'

c	write(473,'(4hDSAA)')
c	write(473,*)'101 71'
c	write(473,*)'167980 168080'
c	write(473,*)'0 +0.01'
c   	write(473,*)'1 100'
	endif
...
c	if(iii.eq.4) then
c	write(400,*) semi,exc,(tf/2.0d0)/conv
c	write(473,*) (tf/2.0d0)/conv
c	dEvmedio=tf/2.0d0
c	endif
...
C	JJ e' o numero total de picos
	...
	if(peri.gt.15.0d0.and.  ampl.gt.( 20.0d0*amplim)  ) dn20=dn20 +1
	if(peri.gt.15.0d0.and.  ampl.gt.( 0.10d0*amplim)  ) dn25=dn25 +1
	if(peri.gt.15.0d0.and.  ampl.gt.( 0.30d0*amplim)  ) dn30=dn30 +1
	if(peri.gt.15.0d0.and.  ampl.gt.( 0.50d0*amplim)  ) dn35=dn35 +1
	if(peri.gt.15.0d0.and.  ampl.gt.( 0.7d0*amplim)  ) dn40=dn40 +1
	if(peri.gt.15.0d0.and.  ampl.gt.( 3.0d0*amplim)  ) dn45=dn45 +1
	if(peri.gt.15.0d0.and.  ampl.gt.( 7.0d0*amplim)  ) dn50=dn50 +1
...
c Mimas
      ...
      a(1)=1.860256406619370d+08/requat
      
      e(1)=2.002855413732700d-02
      e(1)=2.002833386117072d-02
      e(1)=2.002940475619249d-02
      
      di(1)=1.568081505522592d+00*conv
      di(1)=1.567961379446476d+00*conv
      di(1)=1.568178165736470d+00*conv
      
      w(1)=1.496697121023191d+02*conv
      w(1)=1.497709076854479d+02*conv
      w(1)=1.497425790886224d+02*conv
      
      om(1)=9.268827186791158d+01*conv
      om(1)=9.264771224778193d+01*conv
      om(1)=9.266538879646959d+01*conv
      
      am(1)=7.298297803108471d+01*conv
      am(1)=7.291866912551491d+01*conv
      am(1)=7.292980604437224d+01*conv


c      Aegaeon
       dm(2)= dm(1)*(0.33d0/200.0d0)**3.0d0
c10.805d22/5.68462313752d29
      ami(2)=G*(dm0+dm(2))
      dmimi(2)=(dm0+dm(2))/(dm0*dm(2))
      a(2)=aa
c     1.680332379507223E+05
      e(2)=ee
c      3.212287757274269d-03

      di(2)= 1.095303714535553d-03*conv
      om(2)=1.721125168939375d+02*conv
      w(2)=3.053055865889405d+02*conv
      am(2)=1.283184314678524d+00*conv
